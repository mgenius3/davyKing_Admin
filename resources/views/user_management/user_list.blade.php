...
@section('content')
	<div class="d-flex align-items-center mb-3">
		...
		<div class="ms-auto">
			<a href="#" class="btn btn-theme"><i class="fa fa-plus-circle fa-fw me-1"></i> Create User</a>
		</div>
	</div>
						...
						<tbody>
							@foreach ($users as $user)
								<tr>
									...
									<td class="align-middle">${{ number_format($user->wallet_balance, 2) }}</td>
									...
									<td class="align-middle">{{ $user->date_joined->format('M d, Y h:i A') }}</td>
									<td class="align-middle">{{ $user->last_login ? $user->last_login->format('M d, Y h:i A') : 'N/A' }}</td>
									<td class="align-middle">
