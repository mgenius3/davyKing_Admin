document.addEventListener("DOMContentLoaded", () => {
    ...
    //     makeApiRequest("/api/v1/user/update-wallet", "PATCH", {
    ...
    function fundWalletBalance() {
        ...
        makeApiRequest(`/api/v1/users/${userId}/fund-wallet`, "PATCH", {
            amount: fundAmount,
        })
            .then(() => {
                window.showAlert(
    ...
    function deductWalletBalance() {
        ...
        makeApiRequest(`/api/v1/users/${userId}/deduct-wallet`, "PATCH", {
            amount: deductAmount,
        })
            .then(() => {
                window.showAlert(
    ...
    function updateUserStatus() {
        ...
        makeApiRequest(`/api/v1/users/${userId}/${userStatus == "active" ? "active" : "suspend"}`, "PATCH", {
            status: userStatus
        })
            .then(() => {
                window.showAlert(
    ...
    function suspendUser() {
        ...
        makeApiRequest("/api/v1/user/suspend", "PATCH", {})
            .then(() => {
                window.showAlert(
                    "Success!",
    ...
    function resetPassword() {
        ...
        makeApiRequest("/api/v1/user/reset-password", "PATCH", {})
            .then(() => {
                window.showAlert(
                    "Success!",
    ...
    function updateUserPassword() {
        ...
        // Make API request
        makeApiRequest(`/api/v1/users/${userId}/update-password`, "PATCH", { new_password: password })
            .then(() => {
